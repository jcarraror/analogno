...
private:
  ...
  static auto valid(int note) -> bool
  {
...
{
  return !intent.note_ons.empty() || !intent.note_offs.empty() || intent.note_off_all;
}
...
{
  std::cout << "polyphonic MIDI controller running. press Ctrl+C or close the window to quit.\n\n";
